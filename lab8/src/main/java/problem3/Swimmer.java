...
*/
public class Swimmer implements Comparable<problem2.Swimmer> {
  ...
  @Override
//YOUR CODE HERE
  public int compareTo(problem2.Swimmer otherSwimmer) {
    return 0;

  }

  private Integer calcTotalNumEvents(Swimmer swimmer) {
